...
CREATE TABLE public.events (
    ...
    project_id character varying(8) NOT NULL
);
...
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by, installed_on, execution_time, success) VALUES (1, '1', 'Initial', 'SQL', 'V1__Initial.sql', -2075999044, 'postgres', '2022-11-15 09:41:56.071093', 180, true);
INSERT INTO public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by, installed_on, execution_time, success) VALUES (2, '2', 'Fix-sequences-values', 'SQL', 'V2__Fix-sequences-values.sql', 1997237340, 'postgres', '2022-11-24 00:02:34.644454', 217, true);
...
SELECT pg_catalog.setval('public.authorities_auth_id_seq', 9, true);
